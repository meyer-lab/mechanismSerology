...
def makeFigure():
    ...
    f = plotOptimize(cube_zohar, "mean_rcp_autoscale", lrank=False, fitKa=False, maxiter=500, ab_types=HIgGs)
    f.text(0.35, 1, "RMSE Optimization with Per-receptor Autoscale Terms (Zohar)")
    return f